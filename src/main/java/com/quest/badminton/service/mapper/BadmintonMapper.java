...
public class BadmintonMapper {
    ...
    public MatchResponseDto toResponseDto(Match entity, boolean isForAdmin) {
        ...
        return MatchResponseDto.builder()
                ...
                .tourId(entity.getTour().getId())
                .status(entity.getStatus())
                .score1Set1(entity.getScore1Set1())
                .score2Set1(entity.getScore2Set1())
                .score1Set2(entity.getScore1Set2())
                .score2Set2(entity.getScore2Set2())
                .score1Set3(entity.getScore1Set3())
                .score2Set3(entity.getScore2Set3())
                .servePlayerId(entity.getServePlayer() != null ? entity.getServePlayer().getId() : null)
                .receivePlayerId(entity.getReceivePlayer() != null ? entity.getReceivePlayer().getId() : null)
