...
import com.quest.badminton.config.specifications.filter.RangeFilter;
...
public abstract class QueryService<ENTITY> {
     ...
     * @return a Specification
     */
    protected <OTHER, X> Specification<ENTITY> buildReferringEntityStringSpecification(StringFilter filter,
                                                                                 SingularAttribute<? super ENTITY, OTHER> reference,
